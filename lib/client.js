...
function useSessionPolling(options) {
  ...
  const onSessionReadyRef = React6.useRef(onSessionReady);
  onSessionReadyRef.current = onSessionReady;
  const onSessionErrorRef = React6.useRef(onSessionError);
...
function SshSessionPanel(props) {
  const { t } = props;
  const [host, setHost] = React7.useState("");
  const [cwd, setCwd] = React7.useState("");
  const [password, setPassword] = React7.useState("");
  const [privateKey, setPrivateKey] = React7.useState("");
  const [localPort, setLocalPort] = React7.useState("");
  const [nodeVersion, setNodeVersion] = React7.useState("");
  const [dshVersion, setDshVersion] = React7.useState("");
  const [forceRestart, setForceRestart] = React7.useState(false);
  const [refreshMirrors, setRefreshMirrors] = React7.useState(false);
  const [busy, setBusy] = React7.useState(false);
  const [formError, setFormError] = React7.useState("");
  const [envDialogHost, setEnvDialogHost] = React7.useState(null);
  const closeEnvDialog = React7.useCallback(() => {
    setEnvDialogHost(null);
  }, []);
  const [hosts, setHosts] = React7.useState([]);
  const [stopRemote, setStopRemote] = React7.useState(true);
  const logBoxRef = React7.useRef(null);
  const {
    sessions,
    loadError,
    setLoadError,
  ...
  const loadHosts = React7.useCallback(async (refresh) => {
    try {
  ...
  return /* @__PURE__ */ React7.createElement("div", { style: {
    ...
    overflowY: "auto",
    boxSizing: "border-box"
  } }, /* @__PURE__ */ React7.createElement("h2", { style: { margin: 0, fontSize: 18, fontWeight: 600 } }, t("nav")), /* @__PURE__ */ React7.createElement("p", { style: { margin: 0, opacity: 0.75, fontSize: 13 } }, t("sshSectionIntro")), countdown !== null ? /* @__PURE__ */ React7.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center", fontSize: 13 } }, /* @__PURE__ */ React7.createElement("span", null, t("countdown"), " ", countdown.seconds, "s"), /* @__PURE__ */ React7.createElement(
    "button",
    {
      type: "button",
      style: buttonStyle,
    ...
    t("cancelCountdown")
  )) : null, /* @__PURE__ */ React7.createElement("section", { style: { display: "flex", flexDirection: "column", gap: 8 } }, /* @__PURE__ */ React7.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" } }, /* @__PURE__ */ React7.createElement("label", { style: { display: "flex", flexDirection: "column", gap: 2, flex: "1 1 220px" } }, /* @__PURE__ */ React7.createElement("span", { style: { fontSize: 12, opacity: 0.75 } }, t("host")), /* @__PURE__ */ React7.createElement("span", { style: { display: "flex", gap: 4 } }, /* @__PURE__ */ React7.createElement(
    "input",
    {
    ...
    "button",
    {
      ...
      disabled: host.trim() === "",
      onClick: () => {
        setEnvDialogHost(host.trim());
      }
    },
    "\u2699"
  ))), /* @__PURE__ */ React7.createElement("datalist", { id: "dsh-remote-explorer-hosts" }, hosts.map((item) => /* @__PURE__ */ React7.createElement("option", { key: item.alias, value: item.alias }, `${item.user === "" ? "" : `${item.user}@`}${item.hostName}:${item.port}`))), /* @__PURE__ */ React7.createElement("label", { style: { display: "flex", flexDirection: "column", gap: 2, flex: "2 1 300px" } }, /* @__PURE__ */ React7.createElement("span", { style: { fontSize: 12, opacity: 0.75 } }, t("cwd")), /* @__PURE__ */ React7.createElement(
    "input",
    {
      value: cwd,
  ...
  ))), /* @__PURE__ */ React7.createElement("details", null, /* @__PURE__ */ React7.createElement("summary", { style: { cursor: "pointer", fontSize: 13, opacity: 0.75 } }, t("advanced")), /* @__PURE__ */ React7.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 8, marginTop: 8 } }, /* @__PURE__ */ React7.createElement("label", { style: { display: "flex", flexDirection: "column", gap: 2 } }, /* @__PURE__ */ React7.createElement("span", { style: { fontSize: 12, opacity: 0.75 } }, t("localPort")), /* @__PURE__ */ React7.createElement(
    "input",
    {
      value: localPort,
      inputMode: "numeric",
  ...
  )), /* @__PURE__ */ React7.createElement("label", { style: { display: "flex", flexDirection: "column", gap: 2 } }, /* @__PURE__ */ React7.createElement("span", { style: { fontSize: 12, opacity: 0.75 } }, t("privateKey")), /* @__PURE__ */ React7.createElement(
    "input",
    {
      value: privateKey,
      style: inputStyle,
  ...
  )), /* @__PURE__ */ React7.createElement("label", { style: { display: "flex", flexDirection: "column", gap: 2 } }, /* @__PURE__ */ React7.createElement("span", { style: { fontSize: 12, opacity: 0.75 } }, t("nodeVersion")), /* @__PURE__ */ React7.createElement(
    "input",
    {
      value: nodeVersion,
  ...
  )), /* @__PURE__ */ React7.createElement("label", { style: { display: "flex", flexDirection: "column", gap: 2 } }, /* @__PURE__ */ React7.createElement("span", { style: { fontSize: 12, opacity: 0.75 } }, t("dshVersion")), /* @__PURE__ */ React7.createElement(
    "input",
    {
      value: dshVersion,
      style: inputStyle,
  ...
  )), /* @__PURE__ */ React7.createElement("label", { style: { display: "flex", alignItems: "center", gap: 6, fontSize: 13 } }, /* @__PURE__ */ React7.createElement(
    "input",
    {
      type: "checkbox",
  ...
  ), t("forceRestart")), /* @__PURE__ */ React7.createElement("label", { style: { display: "flex", alignItems: "center", gap: 6, fontSize: 13 } }, /* @__PURE__ */ React7.createElement(
    "input",
    {
      type: "checkbox",
  ...
  ), t("refreshMirrors")))), /* @__PURE__ */ React7.createElement("label", { style: { display: "flex", flexDirection: "column", gap: 2, maxWidth: 420 } }, /* @__PURE__ */ React7.createElement("span", { style: { fontSize: 12, opacity: 0.75 } }, t("password")), /* @__PURE__ */ React7.createElement(
    "input",
    {
      type: "password",
      value: password,
  ...
  ), /* @__PURE__ */ React7.createElement("span", { style: { fontSize: 11, opacity: 0.6 } }, t("passwordWarning"))), /* @__PURE__ */ React7.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" } }, DESKTOP ? (
  ...
  ), formError !== "" ? /* @__PURE__ */ React7.createElement("span", { style: { color: "#ef4444", fontSize: 13 } }, t("connectError"), "\uFF1A", formError) : null)), /* @__PURE__ */ React7.createElement("section", null, /* @__PURE__ */ React7.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12, marginBottom: 6 } }, /* @__PURE__ */ React7.createElement("strong", { style: { fontSize: 14 } }, t("sessions")), /* @__PURE__ */ React7.createElement("label", { style: { display: "flex", alignItems: "center", gap: 4, fontSize: 12, opacity: 0.75 } }, /* @__PURE__ */ React7.createElement(
    "input",
    {
      type: "checkbox",
      checked: stopRemote,
  ...
  ), t("stopRemote"))), loadError !== "" ? /* @__PURE__ */ React7.createElement("div", { style: { color: "#ef4444", fontSize: 13, marginBottom: 6 } }, t("loadError"), "\uFF1A", loadError) : null, sessions.length === 0 ? /* @__PURE__ */ React7.createElement("div", { style: { fontSize: 13, opacity: 0.6 } }, t("noSessions")) : /* @__PURE__ */ React7.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 4 } }, sessions.map((session) => renderSessionRow(session, selectedId, t, DESKTOP, {
  ...
  })))), /* @__PURE__ */ React7.createElement(RemotePluginsSection, { sessionId: selectedId, t }), /* @__PURE__ */ React7.createElement("section", null, /* @__PURE__ */ React7.createElement("strong", { style: { fontSize: 14 } }, t("log")), /* @__PURE__ */ React7.createElement("div", { ref: logBoxRef, style: {
    marginTop: 6,
    height: 240,
    overflowY: "auto",
    whiteSpace: "pre-wrap",
    ...
    borderRadius: 6
  } }, selectedId === null || log2.length === 0 ? /* @__PURE__ */ React7.createElement("span", { style: { opacity: 0.55 } }, t("logEmpty")) : log2.map((entry) => /* @__PURE__ */ React7.createElement("div", { key: entry.seq }, /* @__PURE__ */ React7.createElement("span", { style: { opacity: 0.55 } }, entry.ts.slice(11, 19)), " ", /* @__PURE__ */ React7.createElement("span", { style: { opacity: 0.75 } }, "[", entry.kind, "]"), " ", /* @__PURE__ */ React7.createElement("span", { style: entry.kind === "error" ? { color: "#ef4444" } : void 0 }, entry.text))))), envDialogHost !== null ? /* @__PURE__ */ React7.createElement(HostEnvDialog, { hostAlias: envDialogHost, t, onClose: closeEnvDialog }) : null);
}
function renderSessionRow(session, selectedId, t, isDesktop, actions) {
  ...
  return /* @__PURE__ */ React7.createElement(
    ...
    /* @__PURE__ */ React7.createElement("span", { title: stateLabel, style: {
      width: 9,
      height: 9,
      borderRadius: "50%",
      flexShrink: 0,
    ...
    /* @__PURE__ */ React7.createElement("span", { style: { fontWeight: 600, fontSize: 13 } }, session.hostAlias),
    /* @__PURE__ */ React7.createElement("span", { style: { fontSize: 12, opacity: 0.7 } }, session.remoteCwd === "" ? "~" : session.remoteCwd),
    /* @__PURE__ */ React7.createElement("span", { style: { fontSize: 12, opacity: 0.7 } }, stateLabel),
    session.localPort !== void 0 ? /* @__PURE__ */ React7.createElement("span", { style: { fontSize: 12, opacity: 0.7 } }, "127.0.0.1:", session.localPort) : null,
    session.external === true ? /* @__PURE__ */ React7.createElement("span", { style: { fontSize: 11, opacity: 0.6 } }, t("external")) : null,
    session.connectError !== void 0 ? /* @__PURE__ */ React7.createElement("span", { style: { fontSize: 12, color: "#ef4444" } }, session.connectError) : null,
    missingKeys.length > 0 ? /* @__PURE__ */ React7.createElement("span", { style: { fontSize: 11, color: "#f59e0b" }, title: missingKeys.join(", ") }, t("missingKeys"), ": ", missingKeys.join(", ")) : null,
    /* @__PURE__ */ React7.createElement("span", { style: { flex: 1 } }),
    ...
    session.external === true ? null : /* @__PURE__ */ React7.createElement(React7.Fragment, null, /* @__PURE__ */ React7.createElement(
      "button",
      {
        type: "button",
        onClick: (event) => {
      ...
      t("disconnect")
    ), configureEnv !== void 0 ? /* @__PURE__ */ React7.createElement(
      "button",
      {
        type: "button",
        title: t("hostEnvOpen"),
...
function WslSessionPanel(props) {
  const { t } = props;
  const [distroName, setDistroName] = React8.useState("");
  const [cwd, setCwd] = React8.useState("");
  const [wslUser, setWslUser] = React8.useState("");
  ...
  const [distros, setDistros] = React8.useState([]);
  ...
  const loadDistros = React8.useCallback(async (refresh) => {
    try {
  ...
  return /* @__PURE__ */ React8.createElement("div", { style: {
    ...
    overflowY: "auto",
    boxSizing: "border-box"
  } }, /* @__PURE__ */ React8.createElement("h2", { style: { margin: 0, fontSize: 18, fontWeight: 600 } }, t("nav")), /* @__PURE__ */ React8.createElement("p", { style: { margin: 0, opacity: 0.75, fontSize: 13 } }, t("wslSectionIntro")), countdown !== null ? /* @__PURE__ */ React8.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center", fontSize: 13 } }, /* @__PURE__ */ React8.createElement("span", null, t("countdown"), " ", countdown.seconds, "s"), /* @__PURE__ */ React8.createElement(
    "button",
    {
      type: "button",
      style: buttonStyle,
    ...
    "\u21BB"
  ))), /* @__PURE__ */ React8.createElement("datalist", { id: "dsh-remote-explorer-wsl-distros" }, distros.map((distro) => /* @__PURE__ */ React8.createElement("option", { key: distro.name, value: distro.name }, `${distro.name} (${t("wslVersion")} ${distro.version}, ${formatState(distro.state)}${distro.isDefault ? `, ${t("wslDefault")}` : ""})`))), /* @__PURE__ */ React8.createElement("label", { style: { display: "flex", flexDirection: "column", gap: 2, flex: "2 1 300px" } }, /* @__PURE__ */ React8.createElement("span", { style: { fontSize: 12, opacity: 0.75 } }, t("cwd")), /* @__PURE__ */ React8.createElement(
    "input",
    {
      value: cwd,
      placeholder: t("cwdPlaceholder"),
  ...
  ))), /* @__PURE__ */ React8.createElement("label", { style: { display: "flex", flexDirection: "column", gap: 2, maxWidth: 320 } }, /* @__PURE__ */ React8.createElement("span", { style: { fontSize: 12, opacity: 0.75 } }, t("wslUser")), /* @__PURE__ */ React8.createElement(
    "input",
    {
      value: wslUser,
  ...
  ), t("forceRestart")))), /* @__PURE__ */ React8.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" } }, DESKTOP ? /* @__PURE__ */ React8.createElement(
    "button",
    {
      type: "button",
      style: { ...buttonStyle, fontWeight: 600 },
  ...
  })))), /* @__PURE__ */ React8.createElement("section", null, /* @__PURE__ */ React8.createElement("strong", { style: { fontSize: 14 } }, t("log")), /* @__PURE__ */ React8.createElement("div", { ref: logBoxRef, style: {
    marginTop: 6,
    height: 240,
    overflowY: "auto",
    whiteSpace: "pre-wrap",
...
function RemoteSessionRouter(props) {
  const { t } = props;
  const [activeView, setActiveView] = React9.useState("menu");
  const [wslAvailable, setWslAvailable] = React9.useState(null);
  const [wslChecking, setWslChecking] = React9.useState(false);
  const buttonStyle2 = {
    background: "transparent",
    color: "inherit",
    border: "1px solid rgba(127,127,127,0.5)",
  ...
  if (activeView === "menu") {
    ...
    return /* @__PURE__ */ React9.createElement("div", { style: {
      ...
      height: "100%",
      boxSizing: "border-box"
    } }, /* @__PURE__ */ React9.createElement("h2", { style: { margin: 0, fontSize: 18, fontWeight: 600 } }, t("nav")), /* @__PURE__ */ React9.createElement("p", { style: { margin: 0, opacity: 0.75, fontSize: 13 } }, t("sectionIntro")), /* @__PURE__ */ React9.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8, marginTop: 8, maxWidth: 400 } }, /* @__PURE__ */ React9.createElement(
      "button",
      {
        type: "button",
        style: cardStyle,
      ...
      /* @__PURE__ */ React9.createElement("span", { style: { fontWeight: 600, fontSize: 14 } }, t("menuSsh")),
      /* @__PURE__ */ React9.createElement("span", { style: { fontSize: 12, opacity: 0.7 } }, t("sshSectionIntro"))
    ), showWsl && /* @__PURE__ */ React9.createElement(
      "button",
      {
        type: "button",
        style: cardStyle,
      ...
      /* @__PURE__ */ React9.createElement("span", { style: { fontWeight: 600, fontSize: 14 } }, wslChecking ? `${t("menuWsl")}\u2026` : t("menuWsl")),
      /* @__PURE__ */ React9.createElement("span", { style: { fontSize: 12, opacity: 0.7 } }, t("wslSectionIntro"))
    )), wslAvailable === false && /* @__PURE__ */ React9.createElement("div", { style: {
      marginTop: 8,
      padding: "12px 16px",
      maxWidth: 400,
      ...
      fontSize: 13,
      lineHeight: 1.6
    } }, /* @__PURE__ */ React9.createElement("strong", { style: { color: "#ef4444" } }, t("wslNotInstalledTitle")), /* @__PURE__ */ React9.createElement("p", { style: { margin: "6px 0 0", opacity: 0.85 } }, t("wslNotInstalledHint")), /* @__PURE__ */ React9.createElement(
      "button",
      {
        type: "button",
  ...
  return /* @__PURE__ */ React9.createElement("div", { style: { display: "flex", flexDirection: "column", height: "100%" } }, /* @__PURE__ */ React9.createElement("div", { style: { padding: "8px 20px 0", flexShrink: 0 } }, /* @__PURE__ */ React9.createElement(
    "button",
    {
      type: "button",
      style: buttonStyle2,
    ...
    "\u2190 ",
    t("nav")
  )), /* @__PURE__ */ React9.createElement("div", { style: { flex: 1, minHeight: 0 } }, activeView === "ssh" ? /* @__PURE__ */ React9.createElement(SshSessionPanel, { t }) : /* @__PURE__ */ React9.createElement(WslSessionPanel, { t })));
}
function apply(ctx) {
  ctx.effect(
