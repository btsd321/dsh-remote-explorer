...
function useSessionPolling(options) {
  ...
  const onSessionReadyRef = React5.useRef(onSessionReady);
  onSessionReadyRef.current = onSessionReady;
  const onSessionErrorRef = React5.useRef(onSessionError);
...
function SshSessionPanel(props) {
  const { t } = props;
  const [host, setHost] = React6.useState("");
  const [cwd, setCwd] = React6.useState("");
  const [password, setPassword] = React6.useState("");
  const [privateKey, setPrivateKey] = React6.useState("");
  ...
  const [refreshMirrors, setRefreshMirrors] = React6.useState(false);
  const [busy, setBusy] = React6.useState(false);
  const [formError, setFormError] = React6.useState("");
  const [hosts, setHosts] = React6.useState([]);
  ...
  const loadHosts = React6.useCallback(async (refresh) => {
    try {
  ...
  return /* @__PURE__ */ React6.createElement("div", { style: {
  ...
  } }, /* @__PURE__ */ React6.createElement("h2", { style: { margin: 0, fontSize: 18, fontWeight: 600 } }, t("nav")), /* @__PURE__ */ React6.createElement("p", { style: { margin: 0, opacity: 0.75, fontSize: 13 } }, t("sshSectionIntro")), countdown !== null ? /* @__PURE__ */ React6.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center", fontSize: 13 } }, /* @__PURE__ */ React6.createElement("span", null, t("countdown"), " ", countdown.seconds, "s"), /* @__PURE__ */ React6.createElement(
    "button",
    {
      type: "button",
      style: buttonStyle,
    ...
    "\u21BB"
  ))), /* @__PURE__ */ React6.createElement("datalist", { id: "dsh-remote-explorer-hosts" }, hosts.map((item) => /* @__PURE__ */ React6.createElement("option", { key: item.alias, value: item.alias }, `${item.user === "" ? "" : `${item.user}@`}${item.hostName}:${item.port}`))), /* @__PURE__ */ React6.createElement("label", { style: { display: "flex", flexDirection: "column", gap: 2, flex: "2 1 300px" } }, /* @__PURE__ */ React6.createElement("span", { style: { fontSize: 12, opacity: 0.75 } }, t("cwd")), /* @__PURE__ */ React6.createElement(
    "input",
    {
      value: cwd,
  ...
  )), /* @__PURE__ */ React6.createElement("label", { style: { display: "flex", flexDirection: "column", gap: 2 } }, /* @__PURE__ */ React6.createElement("span", { style: { fontSize: 12, opacity: 0.75 } }, t("privateKey")), /* @__PURE__ */ React6.createElement(
    "input",
    {
      value: privateKey,
      style: inputStyle,
  ...
  ), t("forceRestart")), /* @__PURE__ */ React6.createElement("label", { style: { display: "flex", alignItems: "center", gap: 6, fontSize: 13 } }, /* @__PURE__ */ React6.createElement(
    "input",
    {
      type: "checkbox",
  ...
  ), t("refreshMirrors")))), /* @__PURE__ */ React6.createElement("label", { style: { display: "flex", flexDirection: "column", gap: 2, maxWidth: 420 } }, /* @__PURE__ */ React6.createElement("span", { style: { fontSize: 12, opacity: 0.75 } }, t("password")), /* @__PURE__ */ React6.createElement(
    "input",
    {
      type: "password",
      value: password,
  ...
  ), /* @__PURE__ */ React6.createElement("span", { style: { fontSize: 11, opacity: 0.6 } }, t("passwordWarning"))), /* @__PURE__ */ React6.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" } }, DESKTOP ? (
  ...
  ), t("stopRemote"))), loadError !== "" ? /* @__PURE__ */ React6.createElement("div", { style: { color: "#ef4444", fontSize: 13, marginBottom: 6 } }, t("loadError"), "\uFF1A", loadError) : null, sessions.length === 0 ? /* @__PURE__ */ React6.createElement("div", { style: { fontSize: 13, opacity: 0.6 } }, t("noSessions")) : /* @__PURE__ */ React6.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 4 } }, sessions.map((session) => renderSessionRow(session, selectedId, t, DESKTOP, {
    onSelect: setSelectedId,
    onDisconnect: (target) => {
      void onDisconnect(target);
    }
  })))), /* @__PURE__ */ React6.createElement(RemotePluginsSection, { sessionId: selectedId, t }), /* @__PURE__ */ React6.createElement("section", null, /* @__PURE__ */ React6.createElement("strong", { style: { fontSize: 14 } }, t("log")), /* @__PURE__ */ React6.createElement("div", { ref: logBoxRef, style: {
    marginTop: 6,
    height: 240,
    overflowY: "auto",
    whiteSpace: "pre-wrap",
...
function renderSessionRow(session, selectedId, t, isDesktop, actions) {
  ...
  return /* @__PURE__ */ React6.createElement(
    ...
    /* @__PURE__ */ React6.createElement("span", { title: stateLabel, style: {
      width: 9,
      height: 9,
      borderRadius: "50%",
      flexShrink: 0,
    ...
    /* @__PURE__ */ React6.createElement("span", { style: { fontWeight: 600, fontSize: 13 } }, session.hostAlias),
    /* @__PURE__ */ React6.createElement("span", { style: { fontSize: 12, opacity: 0.7 } }, session.remoteCwd === "" ? "~" : session.remoteCwd),
    /* @__PURE__ */ React6.createElement("span", { style: { fontSize: 12, opacity: 0.7 } }, stateLabel),
    session.localPort !== void 0 ? /* @__PURE__ */ React6.createElement("span", { style: { fontSize: 12, opacity: 0.7 } }, "127.0.0.1:", session.localPort) : null,
    session.external === true ? /* @__PURE__ */ React6.createElement("span", { style: { fontSize: 11, opacity: 0.6 } }, t("external")) : null,
    session.connectError !== void 0 ? /* @__PURE__ */ React6.createElement("span", { style: { fontSize: 12, color: "#ef4444" } }, session.connectError) : null,
    missingKeys.length > 0 ? /* @__PURE__ */ React6.createElement("span", { style: { fontSize: 11, color: "#f59e0b" }, title: missingKeys.join(", ") }, t("missingKeys"), ": ", missingKeys.join(", ")) : null,
    ...
    session.external === true ? null : /* @__PURE__ */ React6.createElement(
      "button",
      {
        type: "button",
        onClick: (event) => {
...
function WslSessionPanel(props) {
  const { t } = props;
  const [distroName, setDistroName] = React7.useState("");
  const [cwd, setCwd] = React7.useState("");
  const [wslUser, setWslUser] = React7.useState("");
  ...
  const [distros, setDistros] = React7.useState([]);
  ...
  const loadDistros = React7.useCallback(async (refresh) => {
    try {
  ...
  return /* @__PURE__ */ React7.createElement("div", { style: {
    ...
    overflowY: "auto",
    boxSizing: "border-box"
  } }, /* @__PURE__ */ React7.createElement("h2", { style: { margin: 0, fontSize: 18, fontWeight: 600 } }, t("nav")), /* @__PURE__ */ React7.createElement("p", { style: { margin: 0, opacity: 0.75, fontSize: 13 } }, t("wslSectionIntro")), countdown !== null ? /* @__PURE__ */ React7.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center", fontSize: 13 } }, /* @__PURE__ */ React7.createElement("span", null, t("countdown"), " ", countdown.seconds, "s"), /* @__PURE__ */ React7.createElement(
    "button",
    {
      type: "button",
      style: buttonStyle,
    ...
    "\u21BB"
  ))), /* @__PURE__ */ React7.createElement("datalist", { id: "dsh-remote-explorer-wsl-distros" }, distros.map((distro) => /* @__PURE__ */ React7.createElement("option", { key: distro.name, value: distro.name }, `${distro.name} (${t("wslVersion")} ${distro.version}, ${formatState(distro.state)}${distro.isDefault ? `, ${t("wslDefault")}` : ""})`))), /* @__PURE__ */ React7.createElement("label", { style: { display: "flex", flexDirection: "column", gap: 2, flex: "2 1 300px" } }, /* @__PURE__ */ React7.createElement("span", { style: { fontSize: 12, opacity: 0.75 } }, t("cwd")), /* @__PURE__ */ React7.createElement(
    "input",
    {
      value: cwd,
      placeholder: t("cwdPlaceholder"),
  ...
  ))), /* @__PURE__ */ React7.createElement("label", { style: { display: "flex", flexDirection: "column", gap: 2, maxWidth: 320 } }, /* @__PURE__ */ React7.createElement("span", { style: { fontSize: 12, opacity: 0.75 } }, t("wslUser")), /* @__PURE__ */ React7.createElement(
    "input",
    {
      value: wslUser,
  ...
  ), t("forceRestart")))), /* @__PURE__ */ React7.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" } }, DESKTOP ? /* @__PURE__ */ React7.createElement(
    "button",
    {
      type: "button",
      style: { ...buttonStyle, fontWeight: 600 },
  ...
  })))), /* @__PURE__ */ React7.createElement("section", null, /* @__PURE__ */ React7.createElement("strong", { style: { fontSize: 14 } }, t("log")), /* @__PURE__ */ React7.createElement("div", { ref: logBoxRef, style: {
    marginTop: 6,
    height: 240,
    overflowY: "auto",
    whiteSpace: "pre-wrap",
...
function RemoteSessionRouter(props) {
  const { t } = props;
  const [activeView, setActiveView] = React8.useState("menu");
  const [wslAvailable, setWslAvailable] = React8.useState(null);
  const [wslChecking, setWslChecking] = React8.useState(false);
  const buttonStyle2 = {
    background: "transparent",
    color: "inherit",
    border: "1px solid rgba(127,127,127,0.5)",
  ...
  if (activeView === "menu") {
    ...
    return /* @__PURE__ */ React8.createElement("div", { style: {
      ...
      height: "100%",
      boxSizing: "border-box"
    } }, /* @__PURE__ */ React8.createElement("h2", { style: { margin: 0, fontSize: 18, fontWeight: 600 } }, t("nav")), /* @__PURE__ */ React8.createElement("p", { style: { margin: 0, opacity: 0.75, fontSize: 13 } }, t("sectionIntro")), /* @__PURE__ */ React8.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8, marginTop: 8, maxWidth: 400 } }, /* @__PURE__ */ React8.createElement(
      "button",
      {
        type: "button",
        style: cardStyle,
      ...
      /* @__PURE__ */ React8.createElement("span", { style: { fontWeight: 600, fontSize: 14 } }, t("menuSsh")),
      /* @__PURE__ */ React8.createElement("span", { style: { fontSize: 12, opacity: 0.7 } }, t("sshSectionIntro"))
    ), showWsl && /* @__PURE__ */ React8.createElement(
      "button",
      {
        type: "button",
        style: cardStyle,
      ...
      /* @__PURE__ */ React8.createElement("span", { style: { fontWeight: 600, fontSize: 14 } }, wslChecking ? `${t("menuWsl")}\u2026` : t("menuWsl")),
      /* @__PURE__ */ React8.createElement("span", { style: { fontSize: 12, opacity: 0.7 } }, t("wslSectionIntro"))
    )), wslAvailable === false && /* @__PURE__ */ React8.createElement("div", { style: {
      marginTop: 8,
      padding: "12px 16px",
      maxWidth: 400,
      ...
      fontSize: 13,
      lineHeight: 1.6
    } }, /* @__PURE__ */ React8.createElement("strong", { style: { color: "#ef4444" } }, t("wslNotInstalledTitle")), /* @__PURE__ */ React8.createElement("p", { style: { margin: "6px 0 0", opacity: 0.85 } }, t("wslNotInstalledHint")), /* @__PURE__ */ React8.createElement(
      "button",
      {
        type: "button",
  ...
  return /* @__PURE__ */ React8.createElement("div", { style: { display: "flex", flexDirection: "column", height: "100%" } }, /* @__PURE__ */ React8.createElement("div", { style: { padding: "8px 20px 0", flexShrink: 0 } }, /* @__PURE__ */ React8.createElement(
    "button",
    {
      type: "button",
      style: buttonStyle2,
    ...
    "\u2190 ",
    t("nav")
  )), /* @__PURE__ */ React8.createElement("div", { style: { flex: 1, minHeight: 0 } }, activeView === "ssh" ? /* @__PURE__ */ React8.createElement(SshSessionPanel, { t }) : /* @__PURE__ */ React8.createElement(WslSessionPanel, { t })));
}
function apply(ctx) {
  ctx.effect(
